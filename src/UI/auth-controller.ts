...
authRouter.post("/new-password", limitRequestMiddlewarePassword, inputValueNewPasswordAuth,inputValueRecoveryCodeAuth, ValueMiddleware, authContorller.createNewPassword);

authRouter.post("/password-recovery", limitRequestMiddlewarePassword, inputValueEmailAuthPasswordRecovery,
ValueMiddleware, authContorller.createPasswordRecovery);

authRouter.post("/login", limitRequestMiddleware, inputValueLoginOrEamilAuth, inputValuePasswordAuth, ValueMiddleware, authContorller.createLogin);

authRouter.post("/refresh-token", checkRefreshTokenSecurityDeviceMiddleware, authContorller.cretaeRefreshToken);

authRouter.post("/logout", checkRefreshTokenSecurityDeviceMiddleware, authContorller.cretaeRefreshToken);

authRouter.get("/me", authValidationInfoMiddleware, authContorller.findMe);

authRouter.post("/registration", limitRequestMiddleware, inputValueLoginAuth, inputValuePasswordAuth,
  inputValueEmailRegistrationAuth, ValueMiddleware, authContorller.creteRegistration);

authRouter.post("/registration-confirmation", limitRequestMiddleware, inputValueCodeAuth, ValueMiddleware, authContorller.createRegistrationConfirmation);

authRouter.post("/registration-email-resending", limitRequestMiddleware, inputValueEmailAuth, ValueMiddleware, authContorller.createRegistrationEmailResending);