...
commentsRouter.put("/:commentId", commentAuthorization, inputCommentValidator, ValueMiddleware, commentController.updateByCommentId)
commentsRouter.delete("/:commentId", commentAuthorization, commentController.deleteByCommentId)
